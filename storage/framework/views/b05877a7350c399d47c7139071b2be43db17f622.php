...
<?php else: ?>
    ...
    <div class="container-fluid" id="app">
        ...
        <div class="content-right <?php if($_SERVER['REQUEST_URI'] != "/cabinet/profit"): ?> double-column <?php endif; ?>">
            <cabinet-header
                <?php if($_SERVER['REQUEST_URI'] == "/cabinet/profit"): ?> columns="0" <?php endif; ?>
            :user-info="<?php echo e(\App\Models\User::where('id','=',Auth::id())->with('rang:id,name')->get()); ?>"
        ...
        <?php echo $__env->yieldContent('contentZ'); ?>
        ...
        <footer>
            ...
            <div class="w-100 d-flex justify-content-center my-3 socials">
                ...
                <a target="_blank" href="<?php echo e($socilas->youtube); ?>" class="mx-3"><img
                        src="<?php echo e(asset('img/socials/youtube.svg')); ?>"
                        alt="youtube"></a>
...
<?php endif; ?>
<?php /**PATH C:\Users\Аяз\Desktop\unreal\resources\views/layouts/cabinet.blade.php ENDPATH**/ ?>